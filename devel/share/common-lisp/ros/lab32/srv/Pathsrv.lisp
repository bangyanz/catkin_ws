...
(cl:defmethod cl:initialize-instance :after ((m <Pathsrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pathsrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab32-srv:<Pathsrv-request> is deprecated: use lab32-srv:Pathsrv-request instead.")))

(cl:ensure-generic-function 'gridMap-val :lambda-list '(m))
(cl:defmethod gridMap-val ((m <Pathsrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab32-srv:gridMap-val is deprecated.  Use lab32-srv:gridMap instead.")
  (gridMap m))

(cl:ensure-generic-function 'start-val :lambda-list '(m))
(cl:defmethod start-val ((m <Pathsrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab32-srv:start-val is deprecated.  Use lab32-srv:start instead.")
  (start m))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <Pathsrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab32-srv:goal-val is deprecated.  Use lab32-srv:goal instead.")
  (goal m))
...
(cl:defmethod cl:initialize-instance :after ((m <Pathsrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pathsrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab32-srv:<Pathsrv-response> is deprecated: use lab32-srv:Pathsrv-response instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <Pathsrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab32-srv:path-val is deprecated.  Use lab32-srv:path instead.")
  (path m))
